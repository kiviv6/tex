    ...
    if (navigator.userAgent.match(/iPhone|iPad|iPod/i) || navigator.userAgent.match(/NOKIA/i)) {
        ...
        $('.videoframe').each(function () {
           ...
           var newHeight = oldHeight;
            ...
            if (globalpageLayout == "0") {
                newWidth = $("#content").width() / 100 * 63;
                newHeight = newWidth * (480 / 768);
            } else if (globalpageLayout == "1") {
                newWidth = $("#" + this.id).parent().parent().width();
                newHeight = (newWidth / oldWidth) * oldHeight;
            }
            console.log("oldWidth = " + oldWidth, "newWidth = " + newWidth, "main = " + $(".main").width(), "Document = " + $(document).width());
        ...
        $('.videoframe').each(function () {
            ...
            if ($(window).height() <= 800) width = 549.2;
            else width = 845.84;
